    ...
    <div class="main-container">
        ...
        <div class="subsection subsection2">
            ...
            <div class="button-container">
                <button type="button" onclick="searchDonor()">Search Donor</button>
                <button type="button" onclick="searchBloodBank()">Search Blood Bank</button>
            </div>
...
<script >
    ...
    {
    	// Redirect to the "searchdonor.jsp" page
    	window.location.href='';
    }
    function searchBloodBank()
    {
    	// Redirect to the "searchbloodbank.jsp" page
    	window.location.href='';
    }
    </script>
</body>
