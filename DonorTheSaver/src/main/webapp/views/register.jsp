...
<head>
    ...
    <style>
        ...
        .button-container button {
            padding: 15px 30px;
            font-size: 1.2em;
            background-color: #ff5252; /* Use the same color as the left side background */
            color: #fff;
            border: none;
            border-radius: 5px;
            cursor: pointer;
    ...
    <div class="main-container">
        ...
        <div class="subsection subsection2">
            ...
            <div class="button-container">
                <button type="button" onclick="registerDonor()">Register Donor</button>
                <button type="button" onclick="registerBloodBank()">Register Blood Bank</button>
            </div>
...
<script >
    ...
    {
    	// Redirect to the "registerdonor.jsp" page
    	window.location.href='/registerdonor';
    }
    function registerBloodBank()
    {
    	// Redirect to the "registerbloodbank.jsp" page
    	window.location.href='/registerbloodbank';
    }
    </script>
</body>
</html>
